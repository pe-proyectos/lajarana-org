  ...
  return (
    <nav className="nav">
      <div className="container nav-inner">
        <a href="/" className="logo"><img src="/logo.png" alt="LaJarana" style={{height:'48px',marginRight:'8px',verticalAlign:'middle'}} /> LaJarana <span className="logo-tag">Organizadores</span></a>
